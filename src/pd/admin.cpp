...
int main()
{
	...
	try
	{
		...
		if(!indexPage.SetProdTemplateFile("templates/admin_index.htmlt"))
		{
			CLog	log(ADMIN_LOG_FILE_NAME);
		...
		if(act == "admin_chat_get_cnx_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_chat_get_cnx_list.htmlt");
		...
		if(act == "admin_chat_get_presence_cache")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_chat_get_presence_cache.htmlt");
		...
		if(act == "admin_get_user_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_user_list.htmlt");
		...
		if(act == "admin_get_certificates_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_certificates_list.htmlt");
		...
		if(act == "admin_get_courses_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_courses_list.htmlt");
		...
		if(act == "admin_get_languages_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_languages_list.htmlt");
		...
		if(act == "admin_get_universities_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_universities_list.htmlt");
		...
		if(act == "admin_get_schools_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_schools_list.htmlt");
		...
		if(act == "admin_get_book_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_book_list.htmlt");
		...
		if(act == "admin_get_book_complains_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_book_complains_list.htmlt");
		...
		if(act == "admin_get_complains_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_complains_list.htmlt");
		...
		if(act == "admin_get_companies_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_companies_list.htmlt");
		...
		if(act == "admin_get_occupations_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_occupations_list.htmlt");
		...
		if(act == "admin_get_regions_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_regions_list.htmlt");
		...
		if(act == "admin_get_localities_list")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_localities_list.htmlt");
		...
		if(act == "admin_get_companies_duplicates")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_companies_duplicates.htmlt");
		...
		if(act == "admin_get_pictures_lostindb")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_pictures_lostindb.htmlt");
		...
		if(act == "admin_get_recommendation_adverse")
		{
			...
			indexPage.SetProdTemplateFile("templates/admin_get_recommendation_adverse.htmlt");
		...
		if(act == "AJAX_getUserList")
		{
			...
			indexPage.SetProdTemplateFile("templates/json_response.htmlt");
		...
		if(act == "AJAX_getPicturesLostindb")
		{
			...
			indexPage.SetProdTemplateFile("templates/json_lostpictures.htmlt");
	...
	{
		indexPage.SetProdTemplateFile("templates/error.htmlt");
